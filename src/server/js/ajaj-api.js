...
//
//  FILE:       ajaj-api.js
//  SYSTEM:     C3I Client side AJaJ API model 
...
// nice way, and doesn’t bloat your code with repetitive this and prototype declarations.
    ...
    var c3iAPI = (function() {
        ...
        //
        //      usmAPI.function_name(parameter_list, ...);
        //
...
$(document).ready(function() {
    ...
    //--------------------------------------------------
    $(".c3i-ajax-form").bind('submit', function(event) {
    ...
    //
        ...
        c3iAPI.callAPI(this);                               // that is all we have to do for
    ...
    // dreadfull on a smaller device like a fondleslab or telephone.
        ...
        usmAPI.fetch_list(ALPHABET[index], this);              // go and get multiple tuples from the database
   });
